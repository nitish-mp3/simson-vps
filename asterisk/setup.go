...
; quiet=yes suppresses the hold music and participant-count announcements
; so the phone doesn't hear "you are the only person in this conference"
; while the browser SIP UA is still connecting (takes a few seconds for
; WebRTC ICE/DTLS to complete).
[simson_user]
type=user
quiet=yes
